...
// ProcessInstantKeyConfiguration is an alias for a function that will take in a pointer to an ProcessInstantKeyService and modify it
type ProcessInstantKeyConfiguration func(os *ProcessInstantKeyService) error

// ProcessInstantKeyService is a implementation of the ProcessInstantKeyService
type ProcessInstantKeyService struct {
...
// NewProcessInstantKeyService : instantiate every connection we need to run current game service
func NewProcessInstantKeyService(cfgs ...ProcessInstantKeyConfiguration) (*ProcessInstantKeyService, error) {
	// Create the seasonService
	os := &ProcessInstantKeyService{}
...
func WithMysqlSeasonWeeksRepository(connectionString string) ProcessInstantKeyConfiguration {
	return func(os *ProcessInstantKeyService) error {
...
func WithMysqlMatchesRepository(connectionString string) ProcessInstantKeyConfiguration {
	return func(os *ProcessInstantKeyService) error {
...
func WithMysqlCheckMatchesRepository(connectionString string) ProcessInstantKeyConfiguration {
	return func(os *ProcessInstantKeyService) error {
...
func WithRedisRepository(redisServer string, dbNum int, maxIdle int, maxActive int, idleTimeout time.Duration) ProcessInstantKeyConfiguration {
	return func(os *ProcessInstantKeyService) error {
...
func (s *ProcessInstantKeyService) ReturnZRangeData(ctx context.Context, zSetKey string, fetched int) ([]string, error) {
...
func (s *ProcessInstantKeyService) RedisGet(ctx context.Context, key string) (string, error) {
	return s.redisConn.Get(ctx, key)
}

func (s *ProcessInstantKeyService) RedisZRem(ctx context.Context, list string, key string) (interface{}, error) {
	return s.redisConn.ZRem(ctx, list, key)
}

// GetUpcomingSeasonWeeks : used to return upcoming season week.
func (s *ProcessInstantKeyService) GetUpcomingSeasonWeeks(ctx context.Context, oddsSortedSet, woSortedSet, liveScoreSortedSet string, oddsFactor float64) error {
...
func (s *ProcessInstantKeyService) TeamInfo(leagueID string, teamID string) (string, string) {
...
func (s *ProcessInstantKeyService) Validate(ctx context.Context, leagueID, oddsSortedSet, woSortedSet, liveScoreSortedSet string) (map[int]oddsFiles.CheckKeys, error) {
...
func (s *ProcessInstantKeyService) DecideRatio(ctx context.Context, oddsSortedSet string, totalGames int) ([]string, error) {
...
func (s *ProcessInstantKeyService) TotalGoalsPerSession(ctx context.Context) []int {
...
func (s *ProcessInstantKeyService) NewRandomIndexes(ctx context.Context, max int) map[int]int {
	min := 1
